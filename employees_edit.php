...
if ($_SERVER['REQUEST_METHOD'] == 'GET') {
    ...
    do {
        ...
        if (empty($id) || empty($name) || empty($email) || empty($phone) || empty($address) || empty($client_id)) {
        ...
        try {
            ...
            $sql = "UPDATE employees " .
                "SET name = '$name', email = '$email', phone = '$phone', address = '$address', client_id = '$client_id' " .
                "WHERE id = $id";
            ...
            $sucesso = "Funcionário atualizado com sucessso.";
